...
import { commands } from './ircCommands';
...
export const parseData = (line: string): IRCMessage => {
	...
	const prefixRegex: RegExp = /^:[A-z]+\.[A-z]+\.[A-z]+|^:[A-z]+!~[A-z]+@[A-z0-9-]+.[A-z0-9-]+.[A-z0-9-]+[A-z0-9-]+.[A-z0-9-]+|^:[A-z]+/g;
	// const commandRegex: RegExp = /^:[A-z]+\.[A-z]+\.[A-z]+ ([A-z]+|\d\d\d)|^:[A-z]+ ([A-z]+|\d\d\d)/g;
	const commandRegex: RegExp = /^:[A-z]+\.[A-z]+\.[A-z]+ ([A-z]+|\d\d\d)|^:[A-z]+!~[A-z]+@[A-z0-9-]+.[A-z0-9-]+.[A-z0-9-]+[A-z0-9-]+.[A-z0-9-]+ ([A-z]+|\d\d\d)|^:[A-z]+ ([A-z]+|\d\d\d)/g;
